...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IGitUtil gitUtil, IDotnetUtil dotnetUtil, IProcessUtil processUtil,IFileDownloadUtil fileDownloadUtil, IFileUtil fileUtil)
    {
        _logger = logger;
        _gitUtil = gitUtil;
